    ...
    public partial class CategoryForm : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    dBCon.OpenCon();
                    command.ExecuteNonQuery();
                    MessageBox.Show("Category Updated Successfully", "Update Informatic", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    dBCon.CloseCon();
                    getTable();
                    clear();
                }
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dBCon.OpenCon();
                command.ExecuteNonQuery();
                MessageBox.Show("Category Delete Successfully", "Update Informatic", MessageBoxButtons.OK, MessageBoxIcon.Information);
                dBCon.CloseCon();
                getTable();
                clear();
            }
